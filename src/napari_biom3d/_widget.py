...
def autoconfigure(Use_Configuration_file :bool,
    ...
    if Use_Omero :    
                ...
                print("Using OMERO ! ")
                datasets, img_dir = download_object(hostname=omero_hostname, username=omero_username, password=omero_password, target_dir = "data/to_train/", obj=raw_dataset )
                datasets_mask, msk_dir = download_object(hostname=omero_hostname, username=omero_username, password=omero_password, target_dir = "data/to_train/", obj=mask_dataset )
